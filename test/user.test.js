...
describe("Teste API user",() => {
  ...
  it("Deve inserir um usuário ou retornar um erro de usuário já existente", (done) =>{
    ...
    request.post({url : urlBase + "/user/insert", form: user, headers:headers}, (error, response, body) =>{
  ...
  it("Deve alterar os valores de um usuário de acordo com seu id",(done) =>{
    ...
    request.post({url : urlBase + "/user/update", form: user, headers:headers},(error, response, body) =>{
  ...
  it("Deve excluir o usuáriode de acordo com seu id",(done) =>{
    ...
    request.post({url : urlBase + "/user/delete", form: user, headers:headers},(error, response, body) =>{
