...
describe('Teste API students',() => {
    ...
    it('Deve inserir um estudente, criando também o usuário, se o mesmo não existir', (done) =>{
        ...
        request.post({url : urlBase + '/student/insert', form: student, headers:headers}, (error, response, body) =>{
    ...
    it('Deve alterar os valores de registro de um estudente ',(done) =>{
        ...
        request.post({url : urlBase + '/student/update', form: student, headers:headers},(error, response, body) =>{
    ...
    it('Deve excluir o estutante de acordo com seu id, juntamente com o registro de usuário',(done) =>{
        ...
        request.post({url : urlBase + '/student/delete', form: student, headers:headers},(error, response, body) =>{
    ...
    it('Deve trazer uma lista de todos estudantes cadastrados ',(done) =>{


        request.post({url : urlBase + '/student/loadAll', headers:headers},(error, response, body) =>{
